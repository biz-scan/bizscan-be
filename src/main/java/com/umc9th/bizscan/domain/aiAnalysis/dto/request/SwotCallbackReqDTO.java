...
public class SwotCallbackReqDTO {
  ...
  public record SwotReqDTO(CatchphraseResult catchphrase, SwotResult swot) {}

  /** Python의 CatchphraseResponse 매핑 */
  public record CatchphraseResult(String catchphrase) {}

  /** Python의 SWOTResponse 매핑 */
  public record SwotResult(
      SwotItem strengths, SwotItem weaknesses, SwotItem opportunities, SwotItem threats) {}
