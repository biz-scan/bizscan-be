...
public class ActionPlanCallbackReqDTO {
  ...
  public record FinalSelectReqDTO(@JsonProperty("final_select") FinalSelectResult finalSelect) {}

  public record FinalSelectResult(List<FinalSelect> selections) {}
  ...
  public record ActionDetailReqDTO(@JsonProperty("action_plan") ActionDetailResult actionPlan) {}

  public record ActionDetailResult(List<ActionPlan> plans) {}

  public record ActionPlan(
      int id, String title, @JsonProperty("action_detail") List<ActionDetail> actionDetail) {}
