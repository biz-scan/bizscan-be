...
public class ActionPlanConverter {
  ...
  public static ActionPlan toActionPlan(
      ActionPlanCallbackReqDTO.FinalSelect dto, Analysis analysis, RelatedSwotType swotType) {
  ...
  public static ActionPlanTag toActionPlanTag(
      String tagContent, ActionPlan actionPlan, TagType type) {
    return ActionPlanTag.builder().actionPlan(actionPlan).content(tagContent).type(type).build();
  }
