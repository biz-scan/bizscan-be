...
public enum SecurityErrorStatus implements BaseErrorCode {
  ...
  // 인증 관련 오류(4200~4249)
  AUTH_INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "4350", "유효하지 않은 토큰입니다."),
  AUTH_INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "4351", "유효하지 않은 리프레시 토큰입니다."),
  AUTH_TOKEN_HAS_EXPIRED(HttpStatus.UNAUTHORIZED, "4352", "토큰의 유효기간이 만료되었습니다."),
  AUTH_TOKEN_IS_UNSUPPORTED(HttpStatus.UNAUTHORIZED, "4353", "서버에서 지원하지 않는 토큰 형식입니다."),
  AUTH_IS_NULL(HttpStatus.UNAUTHORIZED, "4354", "토큰 값이 존재하지 않습니다."),
  AUTH_OAUTH2_EMAIL_NOT_FOUND_FROM_PROVIDER(HttpStatus.NOT_FOUND, "4355", "카카오 이메일이 존재하지 않습니다."),
  AUTH_MUST_AUTHORIZED_URI(HttpStatus.UNAUTHORIZED, "4356", "인증이 필요한 URI입니다."),
